...
## Project Structure
    ...
    ├── consultation_creato_35238  # Django project configurations
...
1. Clone this repo and `cd consultation_creato_35238`
...
2. Clone this repo and `cd consultation_creato_35238`
